...
import { Search, Download, BookOpen, ExternalLink } from 'lucide-react';
...
const Notes = () => {
  ...
  const semesters = [
    ...
    },
    {
      ...
      description: 'Complete collection of notes for 6th semester subjects',
      icon: <BookOpen className="w-12 h-12 text-primary" />,
      driveLink: 'https://drive.google.com/drive/folders/1hCOYWYCUcO0MlsNE1hnUWMA443NJWZn3?usp=drive_link'
    },
    {
      id: 7,
  ...
  return (
    <div className="min-h-screen bg-background py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Notes</h1>
          <p className="text-xl text-muted-foreground">
            Access study notes for all semesters
          </p>
        </div>
